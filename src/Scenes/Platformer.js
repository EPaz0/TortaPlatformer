class Platformer extends Phaser.Scene {
    ...
    create() {
        ...
        //this.tortaImage = this.add.image(0, 0, 'torta1').setOrigin(0, 0).setScrollFactor(1);
        // Make it collidable
        ...
        this.physics.add.overlap(my.sprite.player, this.coinGroup, (obj1, obj2) => {
            ...
            this.foodCounter = 0;  // Reset food counter or adjust according to game logic
        ...
        this.foodTimer = this.time.addEvent({
            delay: 50,                // Spawn a food item every 2000 milliseconds
    ...
    eatFood(player, food) {
        ...
        this.foodCounter += 1;  // Assume each food item increases size incrementally
        ...
        if (player.scaleX > 3) { // Adjust condition based on your game's needs
            this.physics.pause();
    ...
    update() {
        ...
        let sizeFactor = my.sprite.player.scaleX; // Assumes scaleX and scaleY are equal
